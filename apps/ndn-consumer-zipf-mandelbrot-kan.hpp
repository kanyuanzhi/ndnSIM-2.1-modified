...
#ifndef NDN_CONSUMER_ZIPF_MANDELBROT_KAN_H_
#define NDN_CONSUMER_ZIPF_MANDELBROT_KAN_H_
 ...
 */
class ConsumerZipfMandelbrotKan : public ConsumerCbrKan {
public:
  static TypeId
  GetTypeId();
   ...
   */
  ConsumerZipfMandelbrotKan();
  virtual ~ConsumerZipfMandelbrotKan();
